...
class ReplayBuffer(object):
  ...
  def sample(self, batch_size):
    ...
    for i in ind:
      ...
      #state = resize(state)
      #state = state.numpy()
      #temp = state.reshape(40,40)
      #patchimg = Image.fromarray(temp.astype("uint8")*255)
      #patch_name = "./images/" + "state" + str(int(i)) + ".jpg"
      ...
      #temp = next_state.reshape(40,40)
      #patchimg = Image.fromarray(temp.astype("uint8")*255)
      #patch_name = "./images/" + "next_state" + str(int(i)) + ".jpg"
      #patchimg.save(patch_name)
